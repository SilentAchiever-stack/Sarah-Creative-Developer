...
const projects = {
    ...
    news: {
        ...
        contribution: "Designed and built the entire platform from scratch, including a hero carousel, four dedicated issue pages, a live news feed integrated via external API, and a fully responsive layout. Every page, component, and API call was written by me.",
    ...
    medicare: {
        ...
        contribution: "Built the complete multi-step booking system, including patient info, specialist selection, time slot picker, and a mock payment UI with card, PayPal, and insurance options. This is a UI/UX simulation; no real payment gateway is integrated. Also built the doctor profiles section, the services grid, and the contact form.",
    ...
    trendverse: {
        ...
        contribution: "Designed and built the full UI from scratch, including a hero section, category grid, product cards with filtering and sorting, a working cart with quantity management and total calculation, and a responsive layout across all screen sizes.",
    ...
    africana: {
        ...
        contribution: "Built the entire platform, including the frontend in HTML/CSS/JS, backend in Node.js and Express, database in MongoDB, with JWT authentication securing customer accounts and order routes. Delivered a complete, client-ready product.",
    ...
    agrotech: {
        ...
        contribution: "Built the full React application, including product browsing by category, cart management with React state, a clean checkout UI, and a responsive layout. Designed the component architecture to keep the app modular and easy to extend.",
    ...
    music: {
        ...
        contribution: "Built the full React app, including API integration for live song/album/artist data, a search feature, genre-based filtering, and a music player UI. Handled async data fetching, loading states, and error boundaries throughout.",
    ...
    calculator: {
        ...
        contribution: "Built entirely from scratch in vanilla JS, including all arithmetic logic, keyboard event listeners, display formatting, and edge case handling. No libraries, no shortcuts.",
        challenge: "Getting operator chaining right: when a user hits 5 + 3 x 2, ensuring the order of operations works correctly and that consecutive operations chain cleanly without resetting unexpectedly.",
        tech: ["HTML", "CSS", "JavaScript"],
